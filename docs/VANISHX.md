...
3. `stories/README.md` + story đang làm (**Epic R** Release · E6 · E11–**E16** Done → `16.*` / `completed/*`)  
4. `stories/completed/` — epic/story Done (1–**6**, 7–9, **11**, **12**, **13**, **14**, **15**) · Epic **16** Done tại `stories/16.*` (+ QA `tmp/epic-16-qa.md`)  
...
**Đã ship:** Panic · App lock · FCM · Block/Report · Pro stub · Epic 5–**6** · **Epic 11** Media · **Epic 12** Chat Detail / Room Options · **Epic 13** Conversation surfaces · **Epic 14** Deferred Deep Link · **Epic 15** Notification Center · **Epic 16** Media capture (document · camera · voice · video · multi-photo).  
QA device smoke checklist: `vanishx-docs/tmp/epic-16-qa.md` (pending human 2-máy).  
**Đang mở:** Epic **R** Release Prod (R.1–R.4). Prod Functions = R.1.
