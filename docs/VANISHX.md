...
3. `stories/README.md` + story đang làm (**R.1–R.4** · E6 · E11–E15 Done → `completed/6.*` · `completed/11.*` · `completed/12.*` · `completed/13.*` · `completed/14.*` · `completed/15.*`)  
4. `stories/completed/` — epic/story Done (1–**6**, 7–9, **11**, **12**, **13**, **14**, **15**)  
...
**Đã ship:** Panic · App lock · FCM · Block/Report · Pro stub · Epic 5–**6** · **Epic 11** Media · **Epic 12** Chat Detail / Room Options · **Epic 13** Conversation surfaces · **Epic 14** Deferred Deep Link · **Epic 15** Notification Center.  
Follow-up media: `vanishx-docs/tmp/from-epic-11.md`.  
**Đang mở:** Epic **R** Release Prod (R.1–R.4 · archive was 6.2). Prod Functions = R.1.
